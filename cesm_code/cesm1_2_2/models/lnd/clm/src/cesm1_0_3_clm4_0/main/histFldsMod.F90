...
!-----------------------------------------------------------------------
    ...
    call hist_addfld1d (fname='SNOWDP_EASS',  units='m',  &
         avgflag='A', long_name='snow height(EASS)', &
         ptr_col=clm3%g%l%c%cps%snowdp_EASS, c2l_scale_type='urbanf')
    !-------------------------------
    ...
    call hist_addfld1d (fname='TG_EASS',  units='K',  &
         avgflag='A', long_name='ground temperature(EASS)', &
         ptr_col=clm3%g%l%c%ces%t_grnd_EASS, c2l_scale_type='urbans')
    ...
    call hist_addfld1d (fname='TG_U_EASS', units='K',  &
         avgflag='A', long_name='Urban ground temperature(EASS)', &
         ptr_col=clm3%g%l%c%ces%t_grnd_u_EASS, set_nourb=spval, c2l_scale_type='urbans')
    ...
    call hist_addfld1d (fname='TG_R_EASS', units='K',  &
         avgflag='A', long_name='Rural ground temperature(EASS)', &
         ptr_col=clm3%g%l%c%ces%t_grnd_r_EASS, set_spec=spval)
    ...
    call hist_addfld2d (fname='TSOI_EASS',  units='K', type2d='levgrnd', &
         avgflag='A', long_name='soil temperature(EASS)', &
         ptr_col=clm3%g%l%c%ces%t_soisno_EASS, c2l_scale_type='urbanh')
    ...
    call hist_addfld1d (fname='TSOI_10CM_EASS',  units='K', &
         avgflag='A', long_name='soil temperature in top 10cm of soil(EASS)', &
         ptr_col=clm3%g%l%c%ces%t_soi_10cm_EASS, set_urb=spval)
    ...
    !-----------------------
    ! added by Jing Chen Oct 2012 Oct 26
    call hist_addfld1d (fname='FGR_EASS', units='watt/m^2',  &
         avgflag='A', long_name='heat flux into soil/snow including snow melt(EASS)', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_soil_grnd_EASS, c2l_scale_type='urbanf')

    call hist_addfld1d (fname='FGR_U_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Urban heat flux into soil/snow including snow melt(EASS)', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_soil_grnd_u_EASS, c2l_scale_type='urbanf', set_nourb=spval)

    call hist_addfld1d (fname='FGR_R_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Rural heat flux into soil/snow including snow melt(EASS)', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_soil_grnd_r_EASS, set_spec=spval)
...
![CML] or [cml] NOTE ---------------------------------------
! phenology output results
!   added by CHE Mingliang, 12/26/2013
    call hist_addfld1d (fname='leafstatus_DLM', units='none', &
         avgflag='A', long_name='leaf status by DLM', &
         ptr_pft=clm3%g%l%c%p%pps%lfstatuscur_DLM, set_urb=0._r8)
    call hist_addfld1d (fname='pgsi_DLM', units='none', &
         avgflag='A', long_name='potential growing season index by DLM', &
         ptr_pft=clm3%g%l%c%p%pps%pgsi_DLM, set_urb=0._r8)
    call hist_addfld1d (fname='idxtemp_DLM', units='none', &
         avgflag='A', long_name='index of temperature by DLM', &
         ptr_pft=clm3%g%l%c%p%pps%idxtemp_DLM, set_urb=0._r8)
    call hist_addfld1d (fname='idxdaylen_DLM', units='none', &
         avgflag='A', long_name='index of daylength by DLM', &
         ptr_pft=clm3%g%l%c%p%pps%idxdaylen_DLM, set_urb=0._r8)
    call hist_addfld1d (fname='idxvpd_DLM', units='none', &
         avgflag='A', long_name='index of vapor pressure deficit of the atmosphere by DLM',&
         ptr_pft=clm3%g%l%c%p%pps%idxvpd_DLM, set_urb=0._r8)
!   added by CHE M.L. 2014-11-11
    call hist_addfld1d (fname='pft_DLM', units='none', &
         avgflag='A', long_name='index for vegetation type (pft)',&
         ptr_pft=clm3%g%l%c%p%pps%pft_DLM)
!----------------------------------------------------------
!   added by CHE M.L., 04/09/2014
!   call hist_addfld1d (fname='vpd', units='pa', &
!         avgflag='A', long_name='vapor pressure deficit by CLM',&
!         ptr_pft=clm3%g%l%c%p%pes%vpd, set_urb=0._r8)
    call hist_addfld1d (fname='vpd_EASS', units='pa', &
         avgflag='A', long_name='vapor pressure deficit by EASS',&
         ptr_pft=clm3%g%l%c%p%pes%vpd_EASS, set_urb=0._r8)
    call hist_addfld1d (fname='es_EASS', units='pa', &
         avgflag='A', long_name='saturated vapor pressure by EASS',&
         ptr_pft=clm3%g%l%c%p%pes%es_EASS, set_urb=0._r8)
    call hist_addfld1d (fname='espar_EASS', units='pa', &
         avgflag='A', long_name='partial vapor pressure by EASS',&
         ptr_pft=clm3%g%l%c%p%pes%espar_EASS, set_urb=0._r8)
![CML] or [cml] NOTE ---------------------------------------

   !-----------------------------------
   !added by Jing Chen, 17 May 2012

    call hist_addfld1d (fname='LAISUN_OVER_EASS', units='none', &
         avgflag='A', long_name='sunlit projected leaf area index,overstory(EASS)', &
         ptr_pft=clm3%g%l%c%p%pps%elai_over_sunlit_EASS)

    call hist_addfld1d (fname='LAISHA_OVER_EASS', units='none', &
         avgflag='A', long_name='shaded projected leaf area index,overstory(EASS)', &
         ptr_pft=clm3%g%l%c%p%pps%elai_over_shaded_EASS)

    call hist_addfld1d (fname='LAISUN_UNDER_EASS', units='none', &
         avgflag='A', long_name='sunlit projected leaf area index,understory(EASS)', &
         ptr_pft=clm3%g%l%c%p%pps%elai_under_sunlit_EASS)

    call hist_addfld1d (fname='LAISHA_UNDER_EASS', units='none', &
         avgflag='A', long_name='shaded projected leaf area index,understory(EASS)', &
         ptr_pft=clm3%g%l%c%p%pps%elai_under_shaded_EASS)

    call hist_addfld1d (fname='elai_over_EASS', units='none', &
         avgflag='A', long_name=' projected leaf area index,overstory(EASS)', &
         ptr_pft=clm3%g%l%c%p%pps%elai_over_EASS)

    call hist_addfld1d (fname='elai_under_EASS', units='none', &
         avgflag='A', long_name=' projected leaf area index,understory(EASS)', &
         ptr_pft=clm3%g%l%c%p%pps%elai_under_EASS)


    !-----------------
    ! resistance
    call hist_addfld1d (fname='RA_OVER_EASS', units='s/m', &
         avgflag='A', long_name='aerodynamical resistance of overstroy(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pps%ra_over_EASS) !, default='inactive')

    call hist_addfld1d (fname='RA_UNDER_EASS', units='s/m', &
         avgflag='A', long_name='aerodynamical resistance of understroy(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pps%ra_under_EASS) !, default='inactive')

    call hist_addfld1d (fname='ra_grnd_EASS', units='s/m', &
         avgflag='A', long_name='aerodynamical resistance of ground(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pps%ra_grnd_EASS) !, default='inactive')


    call hist_addfld1d (fname='RB_OVER_EASS', units='s/m', &
         avgflag='A', long_name='leaf boundry resistance layer of overstroy(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pps%rb_over_EASS) !, default='inactive')

    call hist_addfld1d (fname='RB_UNDER_EASS', units='s/m', &
         avgflag='A', long_name='leaf boundary resistance layer of understroy(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pps%rb_under_EASS) !, default='inactive')

    call hist_addfld1d (fname='Gheat_over_EASS', units='m/s', &
         avgflag='A', long_name='heat conductance, overstroy(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pps%Gheat_over_EASS)

    call hist_addfld1d (fname='Gheat_under_EASS', units='m/s', &
         avgflag='A', long_name='heat conductance, understroy(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pps%Gheat_under_EASS)


    call hist_addfld1d (fname='RB1', units='s/m', &
         avgflag='A', long_name='leaf boundary layer resistance ', &
         ptr_pft=clm3%g%l%c%p%pps%rb1) !, default='inactive')
    ...
    call hist_addfld1d (fname='RS_SUN', units='s/m',  &
         avgflag='A', long_name='sunlit leaf stomatal resistance', &
         ptr_pft=clm3%g%l%c%p%pps%rssun)

    call hist_addfld1d (fname='RS_SHA', units='s/m',  &
         avgflag='A', long_name='shaded leaf stomatal resistance', &
         ptr_pft=clm3%g%l%c%p%pps%rssha)

    call hist_addfld1d (fname='RS_OVER_SUN_EASS', units='s/m',  &
         avgflag='A', long_name='sunlit leaf stomatal resistance,overstroy', &
         ptr_pft=clm3%g%l%c%p%pps%rs_over_sunlit_EASS)

    call hist_addfld1d (fname='RS_OVER_SHA_EASS', units='s/m',  &
         avgflag='A', long_name='shaded leaf stomatal resistance,overstroy', &
         ptr_pft=clm3%g%l%c%p%pps%rs_over_shaded_EASS)

    call hist_addfld1d (fname='RS_UNDER_SUN_EASS', units='s/m',  &
         avgflag='A', long_name='sunlit leaf stomatal resistance,understroy', &
         ptr_pft=clm3%g%l%c%p%pps%rs_under_sunlit_EASS)

    call hist_addfld1d (fname='RS_UNDER_SHA_EASS', units='s/m',  &
         avgflag='A', long_name='shaded leaf stomatal resistance,understroy', &
         ptr_pft=clm3%g%l%c%p%pps%rs_under_shaded_EASS)
    ...
    call hist_addfld1d (fname='DT_VEG', units='K', &
         ...
         ptr_pft=clm3%g%l%c%p%pps%dt_veg)

    call hist_addfld1d (fname='TLEAF_OVER_EASS', units='K', &
         avgflag='A', long_name='temperature of overstory(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pes%Tleaf_over_EASS) !, default='inactive')

    call hist_addfld1d (fname='TLEAF_UNDER_EASS', units='K', &
         avgflag='A', long_name='temperature of understory(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pes%Tleaf_under_EASS) !, default='inactive')

    call hist_addfld1d (fname='TLEAF_SUNLIT_EASS', units='K', &
         avgflag='A', long_name='sunlit leaf temperature(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pes%Tleaf_sunlit_EASS) 

    call hist_addfld1d (fname='TLEAF_SHADED_EASS', units='K', &
         avgflag='A', long_name='shaded leaf temperature(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pes%Tleaf_shaded_EASS) 

    call hist_addfld1d (fname='TLEAF_EASS', units='K', &
         avgflag='A', long_name='leaf temperature(EASS) ', &
         ptr_pft=clm3%g%l%c%p%pes%Tleaf_EASS)


    !-----------------
    !GPP
    call hist_addfld1d (fname='GPP_FPSN_EASS', units='gC m-2 s-1', &
         avgflag='A', long_name='GPP flux based on photosynthesis in EASS', &
         ptr_pft=clm3%g%l%c%p%pcf%gpp_fpsn_EASS)

   call hist_addfld1d (fname='psn_over_sunlit_EASS', units='-', &
         avgflag='A', long_name='sunlit leaf psn', &
         ptr_pft=clm3%g%l%c%p%pcf%psn_over_sunlit_EASS)

   call hist_addfld1d (fname='psn_over_shaded_EASS', units='-', &
         avgflag='A', long_name='sunlit leaf psn', &
         ptr_pft=clm3%g%l%c%p%pcf%psn_over_shaded_EASS)

   call hist_addfld1d (fname='psn_under_sunlit_EASS', units='-', &
         avgflag='A', long_name='sunlit leaf psn', &
         ptr_pft=clm3%g%l%c%p%pcf%psn_under_sunlit_EASS)

   call hist_addfld1d (fname='psn_under_shaded_EASS', units='-', &
         avgflag='A', long_name='sunlit leaf psn', &
         ptr_pft=clm3%g%l%c%p%pcf%psn_under_shaded_EASS)


    call hist_addfld1d (fname='GPP_FPSN_OVER_EASS', units='gC m-2 s-1', &
         avgflag='A', long_name='GPP flux based on photosynthesis in EASS', &
         ptr_pft=clm3%g%l%c%p%pcf%gpp_fpsn_over_EASS)

    call hist_addfld1d (fname='GPP_FPSN_UNDER_EASS', units='gC m-2 s-1', &
         avgflag='A', long_name='GPP flux based on photosynthesis in EASS', &
         ptr_pft=clm3%g%l%c%p%pcf%gpp_fpsn_under_EASS)

    call hist_addfld1d (fname='GPP_FPSN_SUNLIT_EASS', units='gC m-2 s-1', &
         avgflag='A', long_name='GPP flux based on photosynthesis in EASS', &
         ptr_pft=clm3%g%l%c%p%pcf%gpp_fpsn_sunlit_EASS)

    call hist_addfld1d (fname='GPP_FPSN_SHADED_EASS', units='gC m-2 s-1', &
         avgflag='A', long_name='GPP flux based on photosynthesis in EASS', &
         ptr_pft=clm3%g%l%c%p%pcf%gpp_fpsn_shaded_EASS)

    call hist_addfld1d (fname='GPP_FPSN', units='gC m-2 s-1', &
         avgflag='A', long_name='GPP flux based on photosynthesis in CLM', &
         ptr_pft=clm3%g%l%c%p%pcf%gpp_fpsn)

    call hist_addfld1d (fname='GPP_FPSN_SUNLIT', units='gC m-2 s-1', &
         avgflag='A', long_name='GPP flux based on photosynthesis in CLM', &
         ptr_pft=clm3%g%l%c%p%pcf%gpp_fpsn_sunlit)

    call hist_addfld1d (fname='GPP_FPSN_SHADED', units='gC m-2 s-1', &
         avgflag='A', long_name='GPP flux based on photosynthesis in CLM', &
         ptr_pft=clm3%g%l%c%p%pcf%gpp_fpsn_shaded)

    !----------------
    ! flux
    call hist_addfld1d (fname='qflx_evap_can_EASS', units='mmH2O s-1', &
         avgflag='A', long_name='total water vapor heat flux from canopy', &
         ptr_pft=clm3%g%l%c%p%pwf%qflx_evap_can_EASS) !, default='inactive')

    call hist_addfld1d (fname='qflx_evap_grnd_EASS', units='mmH2O s-1', &
         avgflag='A', long_name='total water vapor heat flux from grndsurf', &
         ptr_pft=clm3%g%l%c%p%pwf%qflx_evap_grnd_EASS) !, default='inactive')

    call hist_addfld1d (fname='qflx_evap_tot_EASS', units='mmH2O s-1', &
         avgflag='A', long_name='total water vapor heat flux ', &
         ptr_pft=clm3%g%l%c%p%pwf%qflx_evap_tot_EASS) !, default='inactive')
    ...
    call hist_addfld1d (fname='eflx_lh_can_EASS', units='W m-2', &
         avgflag='A', long_name='total latent heat flux from canopy', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_lh_can_EASS)

    call hist_addfld1d (fname='eflx_lh_grnd_EASS', units='W m-2', &
         avgflag='A', long_name='total latent heat flux from ground surface', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_lh_grnd_EASS) !, default='inactive')

    call hist_addfld1d (fname='eflx_lh_tot_EASS', units='W m-2', &
         avgflag='A', long_name='total latent heat flux ', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_lh_tot_EASS,c2l_scale_type='urbanf') !, default='inactive')

   call hist_addfld1d (fname='eflx_lh_tot_u_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Urban total evaporation in EASS', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_lh_tot_u_EASS, c2l_scale_type='urbanf', set_nourb=spval)

    call hist_addfld1d (fname='eflx_lh_tot_r_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Rural total evaporation in EASS', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_lh_tot_r_EASS, set_spec=spval)

    call hist_addfld1d (fname='eflx_sh_over_EASS', units='W m-2', &
         avgflag='A', long_name='sensible heat flux of overstroy ', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_over_EASS,c2l_scale_type='urbanf')

    call hist_addfld1d (fname='eflx_sh_under_EASS', units='W m-2', &
         avgflag='A', long_name='sensible heat flux of understroy ', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_under_EASS,c2l_scale_type='urbanf')

    call hist_addfld1d (fname='eflx_sh_sunlit_EASS', units='W m-2', &
         avgflag='A', long_name='sensible heat flux of sunlit leaves ', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_sunlit_EASS,c2l_scale_type='urbanf')

    call hist_addfld1d (fname='eflx_sh_shaded_EASS', units='W m-2', &
         avgflag='A', long_name='sensible heat flux of shaded leaves ', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_shaded_EASS,c2l_scale_type='urbanf')

    call hist_addfld1d (fname='eflx_sh_can_EASS', units='W m-2', &
         avgflag='A', long_name='total sensible heat flux of canopy ', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_can_EASS,c2l_scale_type='urbanf')

    call hist_addfld1d (fname='eflx_sh_tot_EASS', units='W m-2', &
         avgflag='A', long_name='total sensible heat flux ', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_tot_EASS,c2l_scale_type='urbanf')  !# c2l_scale_type added by chenjinn

    call hist_addfld1d (fname='eflx_sh_tot_u_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Urban sensible heat in EASS', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_tot_u_EASS, c2l_scale_type='urbanf', set_nourb=spval)

    call hist_addfld1d (fname='eflx_sh_tot_r_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Rural sensible heat in EASS', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_tot_r_EASS, set_spec=spval)

    call hist_addfld1d (fname='eflx_sh_grnd_EASS', units='W m-2', &
         avgflag='A', long_name=' sensible heat flux of grnd ', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_grnd_EASS,c2l_scale_type='urbanf')

    call hist_addfld1d (fname='eflx_sh_grnd_u_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Urban heat flux into soil/snow including snow melt in EASS', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_grnd_u_EASS, c2l_scale_type='urbanf', set_nourb=spval)

    call hist_addfld1d (fname='eflx_sh_grnd_r_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Rural heat flux into soil/snow including snow melt in EASS', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_sh_grnd_r_EASS, set_spec=spval) 

    call hist_addfld1d (fname='EFLX_LH_TOT', units='W/m^2', &
         avgflag='A', long_name='total latent heat flux [+ to atm]', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_lh_tot, c2l_scale_type='urbanf')

    call hist_addfld1d (fname='FVEV', units='watt/m^2',  &
         avgflag='A', long_name='veg evaporation', &
         ptr_pft=clm3%g%l%c%p%pef%eflx_lh_veg, c2l_scale_type='urbanf')

    !---------------------
    ! net radiation
    call hist_addfld1d (fname='RADNET_OVER_EASS', units='W/m2', &
         avgflag='A', long_name='net radiation of overstory ', &
         ptr_pft=clm3%g%l%c%p%pef%radnet_over_EASS) !, default='inactive'

    call hist_addfld1d (fname='RADNET_UNDER_EASS', units='W/m2', &
         avgflag='A', long_name='net radiation of understory ', &
         ptr_pft=clm3%g%l%c%p%pef%radnet_under_EASS) !, default='inactive'

    call hist_addfld1d (fname='RADNET_GRND_EASS', units='W/m2', &
         avgflag='A', long_name='net radiation of ground ', &
         ptr_pft=clm3%g%l%c%p%pef%radnet_grnd_EASS) !, default='inactive'

    call hist_addfld1d (fname='LWNET_EASS', units='W/m2', &
         avgflag='A', long_name='net longwave radiation', &
         ptr_pft=clm3%g%l%c%p%pef%lwnet_EASS) !, default='inactive'

    call hist_addfld1d (fname='lwnet_u_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Urban net infrared (longwave) radiation in EASS', &
         ptr_pft=clm3%g%l%c%p%pef%lwnet_u_EASS, c2l_scale_type='urbanf', set_nourb=spval)

    call hist_addfld1d (fname='lwnet_r_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Rural net infrared (longwave) radiation in EASS', &
         ptr_pft=clm3%g%l%c%p%pef%lwnet_r_EASS, set_spec=spval)

    call hist_addfld1d (fname='SWNET_EASS', units='W/m2', &
         avgflag='A', long_name='net solar radiation', &
         ptr_pft=clm3%g%l%c%p%pef%swnet_EASS, c2l_scale_type='urbanf') !, default='inactive'

    call hist_addfld1d (fname='swnet_u_EASS', units='watt/m^2',  &
         avgflag='A', long_name='Urban net solar radiation in EASS', &
         ptr_pft=clm3%g%l%c%p%pef%swnet_u_EASS, c2l_scale_type='urbanf', set_nourb=spval)

    call hist_addfld1d (fname='RADNET_EASS', units='W/m2', &
         avgflag='A', long_name='net radiation', &
         ptr_pft=clm3%g%l%c%p%pef%radnet_EASS) 

    call hist_addfld1d (fname='RNET', units='watt/m^2',  &
         avgflag='A', long_name='net radiation', &
         ptr_pft=clm3%g%l%c%p%pef%netrad)

    call hist_addfld1d (fname='lwrad_grnd_EASS', units='W/m2', &
         avgflag='A', long_name='net longwave radiation of ground', &
         ptr_pft=clm3%g%l%c%p%pef%lwrad_grnd_EASS)
    ...
    call hist_addfld1d (fname='H2OSNO_EASS',  units='mm',  &
         avgflag='A', long_name='snow depth (liquid water)(EASS)', &
         ptr_col=clm3%g%l%c%cws%h2osno_EASS, c2l_scale_type='urbanf')
   ...
   call hist_addfld1d (fname='H2OCAN_EASS', units='mm',  &
         avgflag='A', long_name='intercepted water(EASS)', &
         ptr_pft=clm3%g%l%c%p%pws%h2ocan_EASS, set_lake=0._r8)
    ...
    call hist_addfld2d (fname='H2OSOI_EASS',  units='mm3/mm3', type2d='levgrnd', &
         avgflag='A', long_name='volumetric soil water(EASS)', &
         ptr_col=clm3%g%l%c%cws%h2osoi_vol_EASS, c2l_scale_type='urbanh')
    ...
    call hist_addfld2d (fname='SOILLIQ_EASS',  units='kg/m2', type2d='levgrnd', &
         avgflag='A', long_name='soil liquid water(EASS)', &
         ptr_col=clm3%g%l%c%cws%h2osoi_liq_EASS, c2l_scale_type='urbanh')
    ...
    call hist_addfld1d (fname='SOILWATER_10CM_EASS',  units='kg/m2', &
         avgflag='A', long_name='soil liquid water + ice in top 10cm of soil(EASS)', &
         ptr_col=clm3%g%l%c%cws%h2osoi_liqice_10cm_EASS, set_urb=spval)
    ...
    call hist_addfld1d (fname='QTOPSOIL_EASS',  units='mm/s',  &
         avgflag='A', long_name='water input to surface(EASS)', &
         ptr_col=clm3%g%l%c%cwf%qflx_top_soil_EASS, c2l_scale_type='urbanf')
    ...
    call hist_addfld1d (fname='QINFL_EASS',  units='mm/s',  &
         avgflag='A', long_name='infiltration(EASS)', &
         ptr_col=clm3%g%l%c%cwf%qflx_infl_EASS, c2l_scale_type='urbanf')
    ...
    call hist_addfld1d (fname='QOVER_EASS',  units='mm/s',  &
         avgflag='A', long_name='surface runoff(EASS)', &
         ptr_col=clm3%g%l%c%cwf%qflx_surf_EASS, c2l_scale_type='urbanf')
    ...
    call hist_addfld1d (fname='qflx_evap_veg_CLM', units='mm/s',  &
         avgflag='A', long_name='canopy evapration', &
         ptr_pft=clm3%g%l%c%p%pwf%qflx_evap_veg, set_lake=0._r8, c2l_scale_type='urbanf')
    ...
    call hist_addfld1d (fname='RHO', units='kg/m^3',  &
         avgflag='A', long_name='surface air density', &
    ...
    call hist_addfld1d (fname='ONSET_FLAG', units='none', &
         ...
         ptr_pft=clm3%g%l%c%p%pepv%onset_flag)
    ...
    call hist_addfld1d (fname='OFFSET_FLAG', units='none', &
         ...
         ptr_pft=clm3%g%l%c%p%pepv%offset_flag)
 ...
 !#        ptr_pft=clm3%g%l%c%p%pps%ram1, default='inactive')  
   ...
   call hist_addfld1d (fname='FV', units='m/s', &
    ...
    !----------------------------
    ! added by Jing Chen, 19 May 2012
    call hist_addfld2d (fname='ALBSNO_OVER_EASS', units='proportion', type2d='numrad', &
         avgflag='A', long_name='albedo of overstroy covered by snow', &
         ptr_col=clm3%g%l%c%cps%albsno_over_EASS )

    call hist_addfld2d (fname='ALBSNO_UNDER_EASS', units='proportion', type2d='numrad', &
         avgflag='A', long_name='albedo of understroy covered by snow', &
         ptr_col=clm3%g%l%c%cps%albsno_under_EASS )

    call hist_addfld2d (fname='ALBSNO_GRUND_EASS', units='proportion', type2d='numrad', &
         avgflag='A', long_name='albedo of ground covered by snow', &
         ptr_col=clm3%g%l%c%cps%albsno_grnd_EASS )
