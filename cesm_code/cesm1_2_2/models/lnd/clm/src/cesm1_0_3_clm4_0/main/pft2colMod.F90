...
! -----------------------------------------------------------------
    ...
    ptrp => clm3%g%l%c%p%pws%h2ocan_EASS
    ptrc => clm3%g%l%c%cws%pws_a%h2ocan_EASS
    call p2c (num_nolakec, filter_nolakec, ptrp, ptrc)
    !------------------------
    ...
    !--------------------
    ! added by Jing Chen Oct 22 2012
    ptrp => clm3%g%l%c%p%pwf%qflx_evap_tot_EASS
    ptrc => clm3%g%l%c%cwf%pwf_a%qflx_evap_tot_EASS
    call p2c (num_allc, filter_allc, ptrp, ptrc)

    ptrp => clm3%g%l%c%p%pwf%qflx_rain_grnd_EASS
    ptrc => clm3%g%l%c%cwf%pwf_a%qflx_rain_grnd_EASS
    call p2c (num_nolakec, filter_nolakec, ptrp, ptrc)

    ptrp => clm3%g%l%c%p%pwf%qflx_snow_grnd_EASS
    ptrc => clm3%g%l%c%cwf%pwf_a%qflx_snow_grnd_EASS
    call p2c (num_nolakec, filter_nolakec, ptrp, ptrc)

    ptrp => clm3%g%l%c%p%pwf%qflx_snwcp_liq_EASS
    ptrc => clm3%g%l%c%cwf%pwf_a%qflx_snwcp_liq_EASS
    call p2c (num_allc, filter_allc, ptrp, ptrc)

    ptrp => clm3%g%l%c%p%pwf%qflx_snwcp_ice_EASS
    ptrc => clm3%g%l%c%cwf%pwf_a%qflx_snwcp_ice_EASS
    call p2c (num_allc, filter_allc, ptrp, ptrc)

    ptrp => clm3%g%l%c%p%pwf%qflx_tran_veg_EASS
    ptrc => clm3%g%l%c%cwf%pwf_a%qflx_tran_veg_EASS
    call p2c (num_nolakec, filter_nolakec, ptrp, ptrc)

    ptrp => clm3%g%l%c%p%pwf%qflx_evap_grnd_EASS
    ptrc => clm3%g%l%c%cwf%pwf_a%qflx_evap_grnd_EASS
    call p2c (num_nolakec, filter_nolakec, ptrp, ptrc)

    ptrp => clm3%g%l%c%p%pwf%qflx_dew_grnd_EASS
    ptrc => clm3%g%l%c%cwf%pwf_a%qflx_dew_grnd_EASS
    call p2c (num_nolakec, filter_nolakec, ptrp, ptrc)

    ptrp => clm3%g%l%c%p%pwf%qflx_sub_snow_EASS
    ptrc => clm3%g%l%c%cwf%pwf_a%qflx_sub_snow_EASS
    call p2c (num_nolakec, filter_nolakec, ptrp, ptrc)

    ptrp => clm3%g%l%c%p%pwf%qflx_dew_snow_EASS
    ptrc => clm3%g%l%c%cwf%pwf_a%qflx_dew_snow_EASS
    call p2c (num_nolakec, filter_nolakec, ptrp, ptrc)
    !--------------------------- 
