...
!
    ...
    !-----------------------
    ! added by Jing Chen Oct 25 2012
...
!                      dke = exp(0.36_r8*(1.0_r8-1.0_r8/satw))                                                      ! add by Shaobo Sun, 2016/08/16                
...
!                      dke = satw                                                                                   ! add by Shaobo Sun, 2016/08/16
!                      dksat = tkmg(c,j) + 0.249_r8*(fl*watsat(c,j)) + 2.29_r8*((1._r8-fl)*watsat(c,j))              ! add by Shaobo Sun, 2016/08/16
!                      dksat = tkmg(c,j) + 0.249_r8*(h2osoi_liq(c,j)/denh2o) + 2.29_r8*(h2osoi_ice(c,j)/denice)     ! add by Shaobo Sun, 2016/08/16
                   endif
          ...
          if (snl(c)+1 < 1 .AND. (j >= snl(c)+1) .AND. (j <= 0)) then  
             ...
             ! add by Shaobo Sun, 2016/08/16
!             thk(c,j) = tkair*(1.0_r8-watsat(c,j)) + 0.249_r8*(h2osoi_liq(c,j)/(denh2o*dz(c,j))) + 2.29_r8*(h2osoi_ice(c,j)/(denice*dz(c,j)))
!             thk(c,j) = 1.105e-6_r8*bw*bw + tkair                                                                          ! add by Shaobo Sun, 2016/08/16, from EASS
          end if
