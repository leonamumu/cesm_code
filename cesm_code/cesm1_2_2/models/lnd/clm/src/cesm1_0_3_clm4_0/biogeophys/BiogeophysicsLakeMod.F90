...
!
    ...
    !---------------------------
    ! added by Jing Chen , Sep 13 2012
...
!-----------------------------------------------------------------------
    ...
    do fp = 1, num_lakep
       ...
       eflx_lh_tot_EASS(p)   = htvp(c)*qflx_evap_soi_EASS(p)
       eflx_lh_grnd_EASS(p)  = htvp(c)*qflx_evap_soi_EASS(p)
       !-------------------------------
    ...
    do fp = 1, num_lakep
       ...
       qflx_prec_grnd_EASS(p) = forc_rain(g) + forc_snow(g)
       !--------------------------------
    end do
