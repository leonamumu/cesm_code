...
!-----------------------------------------------------------------------
   ...
   do fc = 1,num_soilc
      ...
      ! CML OR cml NOTE ------------------------------------
      if (abs(col_errcb(c)) > 1e-8_r8 .and. abs(col_errcb(c)) < 1e-6_r8) then
          print *,'Warning: column cbalance error = ', col_errcb(c), c
      end if
      !CML OR cml NOTE
      !------------------------------------
...
!-----------------------------------------------------------------------
   ...
   do fc = 1,num_soilc
      ...
      ! CML OR cml NOTE ------------------------------------
      if (abs(col_errnb(c)) > 1e-8_r8 .and. abs(col_errnb(c)) < 1e-6_r8) then
         print *,'Warning: column nbalance error = ', col_errnb(c), c
      end if
      !
