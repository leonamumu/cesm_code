...
!EOP
    ...
    !-----------------
    ! added by Jing Chen , Sep 19 2012
    character(len=200) :: char_nh
    integer :: len_nh
...
!------------------------------------------------------------------------
    ...
    !================================================
       ...
       do t = 1,ntapes
          ...
          write (iulog,*) 'locfnhr(t)=',locfnhr(t)      ! added by Jing Chen Sep 19 2012
          call strip_null(locfnh(t))
          write (iulog,*) 'locfnh(t)=',locfnh(t)        ! added by Jing Chen Sep 19 2012
          !--------------------------
          ! added by Jing Chen Sep 19 2012
          char_nh=trim(locfnh(t))
          write (iulog,*) 'char_nh=',char_nh
          len_nh=len(trim(locfnh(t)))
          write (iulog,*) 'len_nh=',len_nh
          write (iulog,*) 'char_nh(len_nh-1:len_nh)=',char_nh(len_nh-1:len_nh)

          do while ( char_nh(len_nh-1:len_nh) /= 'nc' )
                len_nh=len_nh-1
                locfnh(t)=char_nh(:len_nh)
                char_nh=trim(locfnh(t))
                len_nh=len(trim(locfnh(t)))
                write (iulog,*) 'char_nh=',char_nh
                write (iulog,*) 'len_nh=',len_nh
