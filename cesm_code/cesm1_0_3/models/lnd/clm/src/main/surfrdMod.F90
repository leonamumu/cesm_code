...
!!-----------------------------------------------------------------------
    ...
    if (create_glacier_mec_landunit) then          ! call ncd_io_gs_int2d
       ...
       !---------------------------------
       write (iulog,*) 'pctwet=',pctwet
       write (iulog,*) 'pctlak=',pctlak
       write (iulog,*) 'pctgla=',pctgla
       write (iulog,*) 'pcturb=',pcturb
       write (iulog,*) 'glc_topomax=',glc_topomax
       write (iulog,*) 'pctglc_mec=',pctglc_mec
       write (iulog,*) 'topoglc_mec=',topoglc_mec
       !----------------------------------
