...
! Added clumping index in lai calculation, and divid the values of lai into overstory(including sunlit and shaded leaves) and overstory(including sunlit and shaded leaves)
...
!------------------------------------------------------------------------
    ...
    ! variables for EASS code
    allocate(wbal%begwb_EASS(beg:end))
    allocate(wbal%endwb_EASS(beg:end))
    !--------------
    ...
    ! added by Jing Chen Oct 22 2012
    ! variables for EASS code
    wbal%begwb_EASS(beg:end) = nan
    wbal%endwb_EASS(beg:end) = nan
    !--------------
...
!-----------------------------------------------------------------------------------------------
    ...
    ! variables for EASS code
    allocate(pftcon%clumping_pft_EASS(0:numpft)) ! parameter1[2] Clumping_index in EASS
    allocate(pftcon%lai_over_max_EASS(0:numpft)) ! parameter1[8] LAI_max_overstory in EASS
    allocate(pftcon%lai_under_max_EASS(0:numpft)) ! parameter1[9] LAI_max_understory in EASS
    allocate(pftcon%albedo_nir_EASS(0:numpft))
    allocate(pftcon%albedo_vis_EASS(0:numpft))
    allocate(pftcon%albedo_snow_EASS(0:numpft))
    allocate(pftcon%vcmax25_EASS(0:numpft))
    allocate(pftcon%Nleaf_EASS(0:numpft))
    allocate(pftcon%kball_EASS(0:numpft))
    allocate(pftcon%slope_vcmaxN_EASS(0:numpft))
    allocate(pftcon%h2o_ball_barry_EASS(0:numpft))
    allocate(pftcon%hunder_EASS(0:numpft))
    allocate(pftcon%htop_EASS(0:numpft))
    allocate(pftcon%mp_EASS(0:numpft))
!----------------------------------------------------------------------------
...
!-----------------------------
    !added by Jing Chen, 26 March 2012
    ! variables for EASS code
    pftcon%clumping_pft_EASS(:) = nan
    pftcon%lai_over_max_EASS(:) = nan
    pftcon%lai_under_max_EASS(:) = nan
    pftcon%albedo_nir_EASS(:)=nan
    pftcon%albedo_vis_EASS(:)=nan
    pftcon%albedo_snow_EASS(:)=nan
    pftcon%vcmax25_EASS(:)=nan
    pftcon%Nleaf_EASS(:)=nan
    pftcon%kball_EASS(:)=nan
    pftcon%slope_vcmaxN_EASS(:)=nan
    pftcon%h2o_ball_barry_EASS(:)=nan
    pftcon%hunder_EASS(:)=nan
    pftcon%htop_EASS(:)=nan
    pftcon%mp_EASS(:) = nan
!-----------------------------
...
![CML] or [cml] NOTE----------------------------------------------
!   Added by CHE Mingliang. 2013-11-15
    allocate(pps%pgsi_DLM(beg:end))
    allocate(pps%pgsiday_DLM(beg:end))
    allocate(pps%idxtemp_DLM(beg:end))
    allocate(pps%idxdaylen_DLM(beg:end))
!   allocate(pps%idxpnpr_DLM(beg:end))
    allocate(pps%idxvpd_DLM(beg:end))
!   added by CHE M.L. 2014-11-11
    allocate(pps%pft_DLM(beg:end))
!   added by CHE M.L. 2014-11-15
    allocate(pps%pgsiscnt_DLM(beg:end))
    allocate(pps%pgsiecnt_DLM(beg:end))
!   added by CHE M.L. 2013-11-22
    allocate(pps%lfstatuscur_DLM(beg:end))
    allocate(pps%lfstatuspre_DLM(beg:end))
    allocate(pps%lfstatus1cnt_DLM(beg:end))
    allocate(pps%lfstatus2cnt_DLM(beg:end))
    allocate(pps%lfstatus3cnt_DLM(beg:end))
    allocate(pps%lfstatus4cnt_DLM(beg:end))
![CML] or [cml] NOTE----------------------------------------------
...
!----------------------------------------
     !added by Jing Chen, 26 March 2012
     ! variables for EASS code
     allocate(pps%elai_EASS(beg:end))
     allocate(pps%clumping_EASS(beg:end))
     allocate(pps%elai_over_EASS(beg:end))
     allocate(pps%elai_over_shaded_EASS(beg:end))
     allocate(pps%elai_over_sunlit_EASS(beg:end))
     allocate(pps%elai_under_EASS(beg:end))
     allocate(pps%elai_under_shaded_EASS(beg:end))
     allocate(pps%elai_under_sunlit_EASS(beg:end))
     allocate(pps%esai_over_EASS(beg:end))
     allocate(pps%esai_under_EASS(beg:end))
     allocate(pps%lt_over_shaded_EASS(beg:end))
     allocate(pps%lt_over_sunlit_EASS(beg:end))
     allocate(pps%lt_under_shaded_EASS(beg:end))
     allocate(pps%lt_under_sunlit_EASS(beg:end))
     allocate(pps%frac_rain_over_EASS(beg:end))
     allocate(pps%frac_rain_under_EASS(beg:end))
     allocate(pps%frac_snow_over_EASS(beg:end))
     allocate(pps%frac_snow_under_EASS(beg:end))
     allocate(pps%ra_over_EASS(beg:end))
     allocate(pps%ra_under_EASS(beg:end))
     allocate(pps%ra_grnd_EASS(beg:end))
     allocate(pps%rb_over_EASS(beg:end))
     allocate(pps%rb_under_EASS(beg:end))
     allocate(pps%rb_under_EASS(beg:end))
     allocate(pps%Gheat_over_EASS(beg:end))
     allocate(pps%Gheat_under_EASS(beg:end))
     allocate(pps%Gevap_over_EASS(beg:end))
     allocate(pps%Gevap_under_EASS(beg:end))
     allocate(pps%Gleaf_over_sunlit_EASS(beg:end))
     allocate(pps%Gleaf_over_shaded_EASS(beg:end))
     allocate(pps%Gleaf_under_sunlit_EASS(beg:end))
     allocate(pps%Gleaf_under_shaded_EASS(beg:end))
     allocate(pps%ci_over_shaded_EASS(beg:end))
     allocate(pps%ci_over_sunlit_EASS(beg:end))
     allocate(pps%ci_under_shaded_EASS(beg:end))
     allocate(pps%ci_under_sunlit_EASS(beg:end))
     allocate(pps%cs_over_shaded_EASS(beg:end))
     allocate(pps%cs_over_sunlit_EASS(beg:end))
     allocate(pps%cs_under_shaded_EASS(beg:end))
     allocate(pps%cs_under_sunlit_EASS(beg:end))
     allocate(pps%rs_over_shaded_EASS(beg:end))
     allocate(pps%rs_over_sunlit_EASS(beg:end))
     allocate(pps%rs_under_shaded_EASS(beg:end))
     allocate(pps%rs_under_sunlit_EASS(beg:end))
     allocate(pps%rs_grnd_EASS(beg:end))
     allocate(pps%dTleaf_over_sunlit_EASS(beg:end))
     allocate(pps%dTleaf_over_shaded_EASS(beg:end))
     allocate(pps%dTleaf_under_sunlit_EASS(beg:end))
     allocate(pps%dTleaf_under_shaded_EASS(beg:end))
     allocate(pps%jmx_over_shaded_EASS(beg:end))
     allocate(pps%jmx_over_sunlit_EASS(beg:end))
     allocate(pps%jmx_under_shaded_EASS(beg:end))
     allocate(pps%jmx_under_sunlit_EASS(beg:end))
     allocate(pps%vcmx_over_shaded_EASS(beg:end))
     allocate(pps%vcmx_over_sunlit_EASS(beg:end))
     allocate(pps%vcmx_under_shaded_EASS(beg:end))
     allocate(pps%vcmx_under_sunlit_EASS(beg:end))
...
![CML] or [cml] NOTE----------------------------------------------
!   Added by CHE Mingliang. 2013-11-15
    pps%pgsi_DLM(beg:end)      = 0._r8
    pps%pgsiday_DLM(beg:end)   = 0._r8
    pps%idxtemp_DLM(beg:end)   = 0._r8
    pps%idxdaylen_DLM(beg:end) = 0._r8
!   pps%idxpnpr_DLM(beg:end)   = 0._r8
    pps%idxvpd_DLM(beg:end)    = 0._r8
!   added by CHE M.L. 2014-11-11
    pps%pft_DLM(beg:end)       = 0._r8 ! not vegetated
!   added by CHE M.L. 2014-11-15
    pps%pgsiscnt_DLM(beg:end)  = 0._r8
    pps%pgsiecnt_DLM(beg:end)  = 0._r8
!   added by CHE.M.L. 2013-11-15
    pps%lfstatuscur_DLM(beg:end)  = 4._r8
    pps%lfstatuspre_DLM(beg:end)  = 4._r8
    pps%lfstatus1cnt_DLM(beg:end) = 0._r8
    pps%lfstatus2cnt_DLM(beg:end) = 0._r8
    pps%lfstatus3cnt_DLM(beg:end) = 0._r8
    pps%lfstatus4cnt_DLM(beg:end) = 0._r8
![CML] or [cml] NOTE----------------------------------------------
...
!----------------------------------------
     !added by Jing Chen, 26 March 2012
     ! variables for EASS code
     pps%elai_EASS(beg:end) = 0._r8
     pps%clumping_EASS(beg:end) = 0._r8
     pps%elai_over_EASS(beg:end) = 0._r8
     pps%elai_over_shaded_EASS(beg:end) = 0._r8
     pps%elai_over_sunlit_EASS(beg:end) = 0._r8
     pps%elai_under_EASS(beg:end) = 0._r8
     pps%elai_under_shaded_EASS(beg:end) = 0._r8
     pps%elai_under_sunlit_EASS(beg:end) = 0._r8
     pps%esai_over_EASS(beg:end) = 0._r8
     pps%esai_under_EASS(beg:end) = 0._r8
     pps%lt_over_shaded_EASS(beg:end) = 0._r8
     pps%lt_over_sunlit_EASS(beg:end) = 0._r8
     pps%lt_under_shaded_EASS(beg:end) = 0._r8
     pps%lt_under_sunlit_EASS(beg:end) = 0._r8
     pps%frac_rain_over_EASS(beg:end) = 0._r8
     pps%frac_rain_under_EASS(beg:end) = 0._r8
     pps%frac_snow_over_EASS(beg:end) = 0._r8
     pps%frac_snow_under_EASS(beg:end) = 0._r8
     pps%ra_over_EASS(beg:end)=nan
     pps%ra_under_EASS(beg:end)=nan
     pps%ra_grnd_EASS(beg:end)=nan
     pps%rb_over_EASS(beg:end)=nan
     pps%rb_under_EASS(beg:end)=nan
     pps%rb_under_EASS(beg:end)=nan
     pps%Gheat_over_EASS(beg:end)=nan
     pps%Gheat_under_EASS(beg:end)=nan
     pps%Gevap_over_EASS(beg:end)=nan
     pps%Gevap_under_EASS(beg:end)=nan
     pps%Gleaf_over_sunlit_EASS(beg:end)=nan
     pps%Gleaf_over_shaded_EASS(beg:end)=nan
     pps%Gleaf_under_sunlit_EASS(beg:end)=nan
     pps%Gleaf_under_shaded_EASS(beg:end)=nan
     pps%ci_over_shaded_EASS(beg:end)=nan
     pps%ci_over_sunlit_EASS(beg:end)=nan
     pps%ci_under_shaded_EASS(beg:end)=nan
     pps%ci_under_sunlit_EASS(beg:end)=nan
     pps%cs_over_shaded_EASS(beg:end)=nan
     pps%cs_over_sunlit_EASS(beg:end)=nan
     pps%cs_under_shaded_EASS(beg:end)=nan
     pps%cs_under_sunlit_EASS(beg:end)=nan
     pps%rs_over_shaded_EASS(beg:end)=nan
     pps%rs_over_sunlit_EASS(beg:end)=nan
     pps%rs_under_shaded_EASS(beg:end)=nan
     pps%rs_under_sunlit_EASS(beg:end)=nan
     pps%rs_grnd_EASS(beg:end)=nan
     pps%dTleaf_over_sunlit_EASS(beg:end)=nan
     pps%dTleaf_over_shaded_EASS(beg:end)=nan
     pps%dTleaf_under_sunlit_EASS(beg:end)=nan
     pps%dTleaf_under_shaded_EASS(beg:end)=nan
     pps%jmx_over_shaded_EASS(beg:end) = nan
     pps%jmx_over_sunlit_EASS(beg:end) = nan
     pps%jmx_under_shaded_EASS(beg:end) = nan
     pps%jmx_under_sunlit_EASS(beg:end) = nan
     pps%vcmx_over_shaded_EASS(beg:end) = nan
     pps%vcmx_over_sunlit_EASS(beg:end) = nan
     pps%vcmx_under_shaded_EASS(beg:end) = nan
     pps%vcmx_under_sunlit_EASS(beg:end) = nan
!-----------------------------------------
...
!-----------------------------------------------------------------------
    ...
    ! variables for EASS code
    allocate(pes%Tleaf_new_over_sunlit_EASS(beg:end))
    allocate(pes%Tleaf_new_over_shaded_EASS(beg:end)) 
    allocate(pes%Tleaf_new_under_sunlit_EASS(beg:end))
    allocate(pes%Tleaf_new_under_shaded_EASS(beg:end))
    allocate(pes%Tleaf_over_sunlit_EASS(beg:end))
    allocate(pes%Tleaf_under_sunlit_EASS(beg:end))
    allocate(pes%Tleaf_over_shaded_EASS(beg:end))
    allocate(pes%Tleaf_under_shaded_EASS(beg:end))
    allocate(pes%Tleaf_over_EASS(beg:end))
    allocate(pes%Tleaf_under_EASS(beg:end))
    allocate(pes%Tleaf_sunlit_EASS(beg:end))
    allocate(pes%Tleaf_shaded_EASS(beg:end))
    allocate(pes%Tleaf_EASS(beg:end))
    allocate(pes%cpairg_EASS(beg:end))
![CML] or [cml] NOTE -----------------------------
! modified by CHE Mingliang, 2014-11-07
    allocate(pes%vpd(beg:end))
    allocate(pes%vpd_EASS(beg:end))
    allocate(pes%es_EASS(beg:end))
    allocate(pes%espar_EASS(beg:end))
![CML] or [cml] NOTE -----------------------------
    !----------------------
    ...
    ! added by Jing Chen, 20 May 2012
    ! variables for EASS code
    pes%Tleaf_new_over_sunlit_EASS(beg:end) = nan
    pes%Tleaf_new_over_shaded_EASS(beg:end) = nan
    pes%Tleaf_new_under_sunlit_EASS(beg:end) = nan
    pes%Tleaf_new_under_shaded_EASS(beg:end) = nan
    pes%Tleaf_over_sunlit_EASS(beg:end) = nan
    pes%Tleaf_under_sunlit_EASS(beg:end) = nan
    pes%Tleaf_over_shaded_EASS(beg:end) = nan
    pes%Tleaf_under_shaded_EASS(beg:end) = nan 
    pes%Tleaf_over_EASS(beg:end) = nan
    pes%Tleaf_under_EASS(beg:end) = nan
    pes%Tleaf_sunlit_EASS(beg:end) = nan
    pes%Tleaf_shaded_EASS(beg:end) = nan
    pes%Tleaf_EASS(beg:end) = nan
    pes%cpairg_EASS(beg:end)=nan
    !----------------------
![CML] or [cml] NOTE -------------------------------------
    pes%vpd(beg:end)=nan
    pes%vpd_EASS(beg:end)=nan
    pes%es_EASS(beg:end)=nan
    pes%espar_EASS(beg:end)=nan
...
!------------------------------------------------------------------------
    ...
    ! variables for EASS code
    allocate(pws%mass_rain_over_EASS(beg:end))
    allocate(pws%mass_rain_under_EASS(beg:end))
    allocate(pws%mass_snow_over_EASS(beg:end))
    allocate(pws%mass_snow_under_EASS(beg:end))
    allocate(pws%h2ocan_EASS(beg:end))
    !-------------------------
    ...
    !added by Jing Chen, 17 May 2012
    ! variables for EASS code
    pws%mass_rain_over_EASS(beg:end) = nan
    pws%mass_rain_under_EASS(beg:end) = nan
    pws%mass_snow_over_EASS(beg:end) = nan
    pws%mass_snow_under_EASS(beg:end) = nan
    pws%h2ocan_EASS(beg:end) = nan
...
!------------------------------------------------------------------------
    ...
    ! added by Jing Chen, 20 May 2012
    ! variables for EASS code
    allocate(pef%eflx_sh_over_EASS(beg:end))
    allocate(pef%eflx_sh_under_EASS(beg:end))
    allocate(pef%eflx_sh_sunlit_EASS(beg:end))
    allocate(pef%eflx_sh_shaded_EASS(beg:end))
    allocate(pef%eflx_sh_over_sunlit_EASS(beg:end))
    allocate(pef%eflx_sh_under_sunlit_EASS(beg:end))
    allocate(pef%eflx_sh_over_shaded_EASS(beg:end))
    allocate(pef%eflx_sh_under_shaded_EASS(beg:end))
    allocate(pef%radsb_over_sunlit_EASS(beg:end))
    allocate(pef%radsb_over_shaded_EASS(beg:end))
    allocate(pef%radsb_under_sunlit_EASS(beg:end))
    allocate(pef%radsb_under_shaded_EASS(beg:end))
    allocate(pef%radnet_over_EASS(beg:end))
    allocate(pef%radnet_under_EASS(beg:end))
    allocate(pef%radnet_grnd_EASS(beg:end))
    allocate(pef%radnet_EASS(beg:end))
    allocate(pef%lwnet_EASS(beg:end))
    allocate(pef%lwnet_r_EASS(beg:end))
    allocate(pef%lwnet_u_EASS(beg:end))
    allocate(pef%lwrad_grnd_EASS(beg:end))
    allocate(pef%swnet_EASS(beg:end))
    allocate(pef%swnet_u_EASS(beg:end))
    allocate(pef%swnet_over_EASS(beg:end))
    allocate(pef%swnet_under_EASS(beg:end))
    allocate(pef%swnet_grnd_EASS(beg:end))
    allocate(pef%par_over_sunlit_EASS(beg:end))
    allocate(pef%par_over_shaded_EASS(beg:end))
    allocate(pef%par_under_sunlit_EASS(beg:end))
    allocate(pef%par_under_shaded_EASS(beg:end))
    allocate(pef%dalb_over_EASS(beg:end))
    allocate(pef%dalb_under_EASS(beg:end))
    allocate(pef%dalb_grnd_EASS(beg:end))
    allocate(pef%eflx_sh_grnd_EASS(beg:end))
    allocate(pef%eflx_sh_grnd_r_EASS(beg:end))
    allocate(pef%eflx_sh_grnd_u_EASS(beg:end))
    allocate(pef%eflx_sh_tot_EASS(beg:end))
    allocate(pef%eflx_sh_tot_u_EASS(beg:end))
    allocate(pef%eflx_sh_tot_r_EASS(beg:end))
    allocate(pef%eflx_lh_tot_EASS(beg:end))
    allocate(pef%eflx_lh_tot_u_EASS(beg:end))
    allocate(pef%eflx_lh_tot_r_EASS(beg:end))
    allocate(pef%eflx_lh_can_EASS(beg:end))
    allocate(pef%eflx_lh_over_EASS(beg:end))
    allocate(pef%eflx_lh_under_EASS(beg:end))
    allocate(pef%eflx_lh_sunlit_EASS(beg:end))
    allocate(pef%eflx_lh_shaded_EASS(beg:end))
    allocate(pef%eflx_lh_grnd_EASS(beg:end))
    allocate(pef%eflx_lh_veg(beg:end))
    allocate(pef%eflx_sh_can_EASS(beg:end))
    allocate(pef%cgrnd_EASS(beg:end))
    allocate(pef%cgrndl_EASS(beg:end))
    allocate(pef%cgrnds_EASS(beg:end))
    allocate(pef%eflx_soil_grnd_EASS(beg:end))
    allocate(pef%eflx_soil_grnd_r_EASS(beg:end))
    allocate(pef%eflx_soil_grnd_u_EASS(beg:end))
    allocate(pef%eflx_gnet_EASS(beg:end))
    allocate(pef%dgnetdT_EASS(beg:end))
    ...
    ! added by Jing Chen, 17 May 2012
    ! variables for EASS code
    pef%eflx_sh_over_EASS(beg:end) = nan
    pef%eflx_sh_under_EASS(beg:end) = nan
    pef%eflx_sh_sunlit_EASS(beg:end) = nan
    pef%eflx_sh_shaded_EASS(beg:end) = nan
    pef%eflx_sh_over_sunlit_EASS(beg:end) = nan
    pef%eflx_sh_under_sunlit_EASS(beg:end) = nan
    pef%eflx_sh_over_shaded_EASS(beg:end) = nan
    pef%eflx_sh_under_shaded_EASS(beg:end) = nan
    pef%eflx_sh_grnd_EASS(beg:end) = nan
    pef%eflx_sh_grnd_r_EASS(beg:end) = nan
    pef%eflx_sh_grnd_u_EASS(beg:end) = nan
    pef%eflx_sh_tot_EASS(beg:end) = nan
    pef%eflx_sh_tot_u_EASS(beg:end) = nan
    pef%eflx_sh_tot_r_EASS(beg:end) = nan
    pef%eflx_lh_tot_EASS(beg:end) = nan
    pef%eflx_lh_tot_u_EASS(beg:end) = nan
    pef%eflx_lh_tot_r_EASS(beg:end) = nan
    pef%eflx_lh_can_EASS(beg:end) = nan
    pef%eflx_lh_over_EASS(beg:end) = nan
    pef%eflx_lh_under_EASS(beg:end) = nan
    pef%eflx_lh_sunlit_EASS(beg:end) = nan
    pef%eflx_lh_shaded_EASS(beg:end) = nan
    pef%eflx_lh_grnd_EASS(beg:end) = nan
    pef%eflx_lh_veg(beg:end) = nan
    pef%eflx_sh_can_EASS(beg:end) = nan
    pef%radsb_over_sunlit_EASS(beg:end) = nan
    pef%radsb_over_shaded_EASS(beg:end) = nan
    pef%radsb_under_sunlit_EASS(beg:end) = nan
    pef%radsb_under_shaded_EASS(beg:end) = nan
    pef%radnet_over_EASS(beg:end) = nan
    pef%radnet_under_EASS(beg:end) = nan
    pef%radnet_grnd_EASS(beg:end) = nan
    pef%radnet_EASS(beg:end) = nan
    pef%lwnet_EASS(beg:end) = nan
    pef%lwnet_r_EASS(beg:end) = nan
    pef%lwnet_u_EASS(beg:end) = nan
    pef%lwrad_grnd_EASS(beg:end) = nan
    pef%swnet_EASS(beg:end) = nan
    pef%swnet_u_EASS(beg:end) = nan
    pef%swnet_over_EASS(beg:end) = nan
    pef%swnet_under_EASS(beg:end) = nan
    pef%swnet_grnd_EASS(beg:end) = nan
    pef%par_over_sunlit_EASS(beg:end) = nan
    pef%par_over_shaded_EASS(beg:end) = nan
    pef%par_under_sunlit_EASS(beg:end) = nan
    pef%par_under_shaded_EASS(beg:end) = nan
    pef%dalb_over_EASS(beg:end) = nan
    pef%dalb_under_EASS(beg:end) = nan
    pef%dalb_grnd_EASS(beg:end) = nan
    pef%cgrnd_EASS(beg:end) = nan
    pef%cgrndl_EASS(beg:end) = nan
    pef%cgrnds_EASS(beg:end) = nan
    pef%eflx_soil_grnd_EASS(beg:end) = nan
    pef%eflx_soil_grnd_r_EASS(beg:end) = nan
    pef%eflx_soil_grnd_u_EASS(beg:end) = nan
    pef%eflx_gnet_EASS(beg:end) = nan
    pef%dgnetdT_EASS(beg:end) = nan
    !--------------
...
!------------------------------------------------------------------------
    ...
    ! added by Jing Chen, 17 May 2012
    ! variables for EASS code
    allocate(pwf%snow_grnd_EASS(beg:end))
    allocate(pwf%sum_rain_over_EASS(beg:end))
    allocate(pwf%sum_rain_under_EASS(beg:end))
    allocate(pwf%sum_snow_over_EASS(beg:end))
    allocate(pwf%sum_snow_under_EASS(beg:end))
    allocate(pwf%sum_snow_EASS(beg:end))
    allocate(pwf%qflx_trans_over_EASS(beg:end))
    allocate(pwf%qflx_trans_under_EASS(beg:end))
    allocate(pwf%qflx_trans_sunlit_EASS(beg:end))
    allocate(pwf%qflx_trans_shaded_EASS(beg:end))
    allocate(pwf%qflx_trans_over_sunlit_EASS(beg:end))
    allocate(pwf%qflx_trans_under_sunlit_EASS(beg:end))
    allocate(pwf%qflx_trans_over_shaded_EASS(beg:end))
    allocate(pwf%qflx_trans_under_shaded_EASS(beg:end))
    allocate(pwf%qflx_evap_over_EASS(beg:end))
    allocate(pwf%qflx_evap_under_EASS(beg:end))
    allocate(pwf%qflx_evap_sunlit_EASS(beg:end))
    allocate(pwf%qflx_evap_shaded_EASS(beg:end))
    allocate(pwf%qflx_evap_over_sunlit_EASS(beg:end))
    allocate(pwf%qflx_evap_under_sunlit_EASS(beg:end))
    allocate(pwf%qflx_evap_over_shaded_EASS(beg:end))
    allocate(pwf%qflx_evap_under_shaded_EASS(beg:end))
    allocate(pwf%qflx_evap_snow_over_EASS(beg:end))
    allocate(pwf%qflx_evap_snow_under_EASS(beg:end))
    allocate(pwf%qflx_evap_snow_sunlit_EASS(beg:end))
    allocate(pwf%qflx_evap_snow_shaded_EASS(beg:end))
    allocate(pwf%qflx_evap_snow_over_sunlit_EASS(beg:end))
    allocate(pwf%qflx_evap_snow_under_sunlit_EASS(beg:end))
    allocate(pwf%qflx_evap_snow_over_shaded_EASS(beg:end))
    allocate(pwf%qflx_evap_snow_under_shaded_EASS(beg:end))
    allocate(pwf%qflx_evap_soi_EASS(beg:end))
    allocate(pwf%qflx_evap_pond_EASS(beg:end))
    allocate(pwf%qflx_evap_snow_grnd_EASS(beg:end))
    allocate(pwf%qflx_evap_tot_EASS(beg:end))
    allocate(pwf%qflx_evap_can_EASS(beg:end))
    allocate(pwf%qflx_evtr_sunlit_EASS(beg:end))
    allocate(pwf%qflx_evtr_shaded_EASS(beg:end))
    allocate(pwf%qflx_evap_grnd_EASS(beg:end))
    allocate(pwf%qflx_dew_grnd_EASS(beg:end))
    allocate(pwf%qflx_dew_snow_EASS(beg:end))
    allocate(pwf%qflx_prec_grnd_EASS(beg:end))
    allocate(pwf%qflx_prec_intr_EASS(beg:end))
    allocate(pwf%qflx_rain_grnd_EASS(beg:end))
    allocate(pwf%qflx_snwcp_liq_EASS(beg:end))
    allocate(pwf%qflx_sub_snow_EASS(beg:end))
    allocate(pwf%qflx_snwcp_ice_EASS(beg:end))
    allocate(pwf%qflx_snow_grnd_EASS(beg:end))
    allocate(pwf%qflx_tran_veg_EASS(beg:end))
    !---------------
    ...
    ! added by Jing Chen, 17 May 2012
    ! variables for EASS code
    pwf%snow_grnd_EASS(beg:end) = nan
    pwf%sum_rain_over_EASS(beg:end) = nan
    pwf%sum_rain_under_EASS(beg:end) = nan
    pwf%sum_snow_over_EASS(beg:end) = nan
    pwf%sum_snow_under_EASS(beg:end) = nan
    pwf%sum_snow_EASS(beg:end) = nan
    pwf%qflx_trans_over_EASS(beg:end) = nan
    pwf%qflx_trans_under_EASS(beg:end) = nan
    pwf%qflx_trans_sunlit_EASS(beg:end) = nan
    pwf%qflx_trans_shaded_EASS(beg:end) = nan
    pwf%qflx_trans_over_sunlit_EASS(beg:end) = nan
    pwf%qflx_trans_under_sunlit_EASS(beg:end) = nan
    pwf%qflx_trans_over_shaded_EASS(beg:end) = nan
    pwf%qflx_trans_under_shaded_EASS(beg:end) = nan
    pwf%qflx_evap_over_EASS(beg:end) = nan
    pwf%qflx_evap_under_EASS(beg:end) = nan
    pwf%qflx_evap_sunlit_EASS(beg:end) = nan
    pwf%qflx_evap_shaded_EASS(beg:end) = nan
    pwf%qflx_evap_over_sunlit_EASS(beg:end) = nan
    pwf%qflx_evap_under_sunlit_EASS(beg:end) = nan
    pwf%qflx_evap_over_shaded_EASS(beg:end) = nan
    pwf%qflx_evap_under_shaded_EASS(beg:end) = nan
    pwf%qflx_evap_snow_over_EASS(beg:end) = nan
    pwf%qflx_evap_snow_under_EASS(beg:end) = nan
    pwf%qflx_evap_snow_sunlit_EASS(beg:end) = nan
    pwf%qflx_evap_snow_shaded_EASS(beg:end) = nan
    pwf%qflx_evap_snow_over_sunlit_EASS(beg:end) = nan
    pwf%qflx_evap_snow_under_sunlit_EASS(beg:end) = nan
    pwf%qflx_evap_snow_over_shaded_EASS(beg:end) = nan
    pwf%qflx_evap_snow_under_shaded_EASS(beg:end) = nan
    pwf%qflx_evap_soi_EASS(beg:end) = nan
    pwf%qflx_evap_pond_EASS(beg:end) = nan
    pwf%qflx_evap_snow_grnd_EASS(beg:end) = nan
    pwf%qflx_evap_tot_EASS(beg:end) = nan
    pwf%qflx_evap_can_EASS(beg:end) = nan
    pwf%qflx_evtr_sunlit_EASS(beg:end) = nan
    pwf%qflx_evtr_shaded_EASS(beg:end) = nan
    pwf%qflx_evap_grnd_EASS(beg:end) = nan
    pwf%qflx_dew_grnd_EASS(beg:end) = nan
    pwf%qflx_dew_snow_EASS(beg:end) = nan
    pwf%qflx_prec_grnd_EASS(beg:end) = nan
    pwf%qflx_prec_intr_EASS(beg:end) = nan
    pwf%qflx_rain_grnd_EASS(beg:end) = nan
    pwf%qflx_snwcp_liq_EASS(beg:end) = nan
    pwf%qflx_snwcp_ice_EASS(beg:end) = nan
    pwf%qflx_sub_snow_EASS(beg:end) = nan
    pwf%qflx_snow_grnd_EASS(beg:end) = nan
    pwf%qflx_tran_veg_EASS(beg:end) = nan
   !---------------
...
!------------------------------------------------------------------------
    ...
    ! added by Jing Chen, 20 May 2012
    ! variables for EASS code
    allocate(pcf%psn_over_shaded_EASS(beg:end))
    allocate(pcf%psn_over_sunlit_EASS(beg:end))
    allocate(pcf%psn_under_shaded_EASS(beg:end))
    allocate(pcf%psn_under_sunlit_EASS(beg:end))
    allocate(pcf%fpsn_over_sunlit_EASS(beg:end))
    allocate(pcf%fpsn_over_shaded_EASS(beg:end))
    allocate(pcf%fpsn_under_sunlit_EASS(beg:end))
    allocate(pcf%fpsn_under_shaded_EASS(beg:end))
    allocate(pcf%gpp_fpsn_EASS(beg:end))
    allocate(pcf%gpp_fpsn_over_EASS(beg:end))
    allocate(pcf%gpp_fpsn_under_EASS(beg:end))
    allocate(pcf%gpp_fpsn_sunlit_EASS(beg:end))
    allocate(pcf%gpp_fpsn_shaded_EASS(beg:end))
    allocate(pcf%gpp_fpsn(beg:end))
    allocate(pcf%gpp_fpsn_sunlit(beg:end))
    allocate(pcf%gpp_fpsn_shaded(beg:end))
    !-------------------------
    ...
    ! added by Jing Chen, 20 May 2012
    ! variables for EASS code
    pcf%psn_over_shaded_EASS(beg:end) = nan
    pcf%psn_over_sunlit_EASS(beg:end) = nan
    pcf%psn_under_shaded_EASS(beg:end) = nan
    pcf%psn_under_sunlit_EASS(beg:end) = nan
    pcf%fpsn_over_sunlit_EASS(beg:end) = nan
    pcf%fpsn_over_shaded_EASS(beg:end) = nan
    pcf%fpsn_under_sunlit_EASS(beg:end) = nan
    pcf%fpsn_under_shaded_EASS(beg:end) = nan
    pcf%gpp_fpsn_EASS(beg:end) = nan
    pcf%gpp_fpsn_over_EASS(beg:end) = nan
    pcf%gpp_fpsn_under_EASS(beg:end) = nan
    pcf%gpp_fpsn_sunlit_EASS(beg:end) = nan
    pcf%gpp_fpsn_shaded_EASS(beg:end) = nan
    pcf%gpp_fpsn(beg:end) = nan
    pcf%gpp_fpsn_sunlit(beg:end) = nan
    pcf%gpp_fpsn_shaded(beg:end) = nan
    !-------------------------
...
!------------------------------------------------------------------------
    ...
    allocate(cps%tksat0(beg:end,nlevgrnd))            !Added by Shaobo Sun
...
!   allocate(cps%xirrig(beg:end))
    ...
    ! variables for EASS code
    allocate(cps%snowdp_EASS(beg:end))
    allocate(cps%frac_snow_grnd_EASS(beg:end))
    allocate(cps%ponddp_EASS(beg:end))
    allocate(cps%albsnow_EASS(beg:end,numrad))
    allocate(cps%alb_can_EASS(beg:end,numrad))
    allocate(cps%albsno_over_EASS(beg:end,numrad))
    allocate(cps%albsno_under_EASS(beg:end,numrad))
    allocate(cps%alb_grnd_EASS(beg:end,numrad))
    allocate(cps%albsno_grnd_EASS(beg:end,numrad))
    allocate(cps%dz_EASS(beg:end,-nlevsno+1:nlevgrnd))
    allocate(cps%frac_iceold_EASS(beg:end,-nlevsno+1:nlevgrnd))
    allocate(cps%rootr_column_EASS(beg:end,nlevgrnd))
    allocate(cps%snl_EASS(beg:end))
    allocate(cps%z_EASS(beg:end,-nlevsno+1:nlevgrnd))
    allocate(cps%zi_EASS(beg:end,-nlevsno+0:nlevgrnd))
    allocate(cps%imelt_EASS(beg:end,-nlevsno+1:nlevgrnd))
    allocate(cps%eff_porosity_EASS(beg:end,nlevgrnd))
    allocate(cps%fracice_EASS(beg:end,nlevgrnd))
    allocate(cps%wf_EASS(beg:end))
    allocate(cps%soilpsi_EASS(beg:end,nlevgrnd))
    !----------------
    ...
    cps%tksat0(beg:end,1:nlevgrnd) = nan   !add by Shaobo Sun
...
!   cps%xirrig(beg:end) = 0._r8
    ...
    !added by Jing Chen, 18 May 2012
   ! variables for EASS code
    cps%snowdp_EASS(beg:end) = nan
    cps%frac_snow_grnd_EASS(beg:end) = nan
    cps%ponddp_EASS(beg:end) = nan
    cps%albsnow_EASS(beg:end,:numrad) = nan
    cps%alb_can_EASS(beg:end,:numrad) = nan
    cps%albsno_over_EASS(beg:end,:numrad) = nan
    cps%albsno_under_EASS(beg:end,:numrad) = nan
    cps%alb_grnd_EASS(beg:end,:numrad) = nan
    cps%albsno_grnd_EASS(beg:end,:numrad) = nan
    cps%dz_EASS(beg:end,-nlevsno+1:nlevgrnd) = nan
    cps%frac_iceold_EASS(beg:end,-nlevsno+1:nlevgrnd) = spval
    cps%rootr_column_EASS(beg:end,1:nlevgrnd) = spval
    cps%z_EASS(beg:end,-nlevsno+1:nlevgrnd) = nan
    cps%zi_EASS(beg:end,-nlevsno+1:nlevgrnd) = nan
    cps%imelt_EASS(beg:end,-nlevsno+1:nlevgrnd) = bigint
    cps%eff_porosity_EASS(beg:end,1:nlevgrnd) = spval
    cps%fracice_EASS(beg:end,1:nlevgrnd) = nan
    cps%soilpsi_EASS(beg:end,1:nlevgrnd) = spval
    cps%wf_EASS(beg:end) = nan
    !-----------------
...
!------------------------------------------------------------------------
    ...
    ! added by Jing Chen Oct 22 2012
    ! variables for EASS code
    allocate(ces%t_grnd_EASS(beg:end))
    allocate(ces%t_grnd_r_EASS(beg:end))
    allocate(ces%t_grnd_u_EASS(beg:end))
    allocate(ces%t_soi_10cm_EASS(beg:end))
    allocate(ces%t_soisno_EASS(beg:end,-nlevsno+1:nlevgrnd))
    allocate(ces%tssbef_EASS(beg:end,-nlevsno+1:nlevgrnd))
    allocate(ces%hc_soi_EASS(beg:end))
    allocate(ces%hc_soisno_EASS(beg:end))
    allocate(ces%t_grnd_bef_EASS(beg:end))
    allocate(ces%t_grnd_bef(beg:end))
    !------------------
    ...
    ! added by Jing Chen Oct 22 2012
    ! variables for EASS code
    ces%t_grnd_EASS(beg:end) = nan
    ces%t_grnd_r_EASS(beg:end) = nan
    ces%t_grnd_u_EASS(beg:end) = nan
    ces%t_grnd_bef_EASS(beg:end) = nan
    ces%t_grnd_bef(beg:end) = nan
    ces%t_soi_10cm_EASS(beg:end) = spval
    ces%t_soisno_EASS(beg:end,-nlevsno+1:nlevgrnd) = spval
    ces%tssbef_EASS(beg:end,-nlevsno+1:nlevgrnd)   = nan
    ces%hc_soi_EASS(beg:end)    = nan
    ces%hc_soisno_EASS(beg:end) = nan
    !---------------
...
!------------------------------------------------------------------------
    ...
    ! added by Jing Chen Oct 22 2012
    ! variables for EASS code
    allocate(cws%h2osno_EASS(beg:end))
    allocate(cws%h2osoi_ice_EASS(beg:end,-nlevsno+1:nlevgrnd))
    allocate(cws%h2osoi_liq_EASS(beg:end,-nlevsno+1:nlevgrnd))
    allocate(cws%h2osoi_liqice_10cm_EASS(beg:end))
    allocate(cws%h2osoi_vol_EASS(beg:end,1:nlevgrnd))
    allocate(cws%mass_snow_grnd_EASS(beg:end))
    allocate(cws%qcharge_EASS(beg:end))
    allocate(cws%snowice_EASS(beg:end))
    allocate(cws%snowliq_EASS(beg:end))
    allocate(cws%wa_EASS(beg:end))
    allocate(cws%wt_EASS(beg:end))
    allocate(cws%zwt_EASS(beg:end))
    !------------------------
    ...
    ! added by Jing Chen Oct 22 2012
    ! variables for EASS code
    cws%h2osno_EASS(beg:end) = nan
    cws%h2osoi_ice_EASS(beg:end,-nlevsno+1:nlevgrnd) = spval
    cws%h2osoi_liq_EASS(beg:end,-nlevsno+1:nlevgrnd) = spval
    cws%h2osoi_liqice_10cm_EASS(beg:end) = nan
    cws%h2osoi_vol_EASS(beg:end,1:nlevgrnd) = spval
    cws%mass_snow_grnd_EASS(beg:end) = nan
    cws%qcharge_EASS(beg:end) = nan
    cws%snowice_EASS(beg:end) = nan
    cws%snowliq_EASS(beg:end) = nan
    cws%wa_EASS(beg:end) = nan
    cws%wt_EASS(beg:end) = nan
    cws%zwt_EASS(beg:end) = nan
    !---------------------
...
!------------------------------------------------------------------------
    ...
    ! added by Jing Chen Oct 22 2012
    ! variables for EASS code
    allocate(cef%eflx_bot_EASS(beg:end))
    allocate(cef%eflx_snomelt_EASS(beg:end))
    allocate(cef%eflx_snomelt_r_EASS(beg:end))
    allocate(cef%eflx_fgr12_EASS(beg:end))
    allocate(cef%eflx_impsoil_EASS(beg:end))
    !----------------
    ...
    ! added by Jing Chen Oct 22 2012
    ! variables for EASS code
    cef%eflx_bot_EASS(beg:end)       = nan
    cef%eflx_snomelt_EASS(beg:end)   = nan
    cef%eflx_snomelt_r_EASS(beg:end) = nan
    cef%eflx_fgr12_EASS(beg:end)     = nan
    cef%eflx_impsoil_EASS(beg:end)   = nan
    !-----------------
...
!------------------------------------------------------------------------
    ...
    !added by Jing Chen, 17 May 2012
    ! variables for EASS code
    allocate(cwf%densnow_EASS(beg:end))
    allocate(cwf%densnow_EASS(beg:end))
    allocate(cwf%qflx_drain_EASS(beg:end))
    allocate(cwf%qflx_glcice_EASS(beg:end))
    allocate(cwf%qflx_infl_EASS(beg:end))
    allocate(cwf%qflx_qrgwl_EASS(beg:end))
    allocate(cwf%qflx_rsub_sat_EASS(beg:end))
    allocate(cwf%qflx_runoff_EASS(beg:end))
    allocate(cwf%qflx_runoff_r_EASS(beg:end))
    allocate(cwf%qflx_runoff_u_EASS(beg:end))
    allocate(cwf%qflx_snomelt_EASS(beg:end))
    allocate(cwf%qflx_surf_EASS(beg:end))
    allocate(cwf%qflx_top_soil_EASS(beg:end))
    allocate(cwf%qflx_snofrz_lyr_EASS(beg:end,-nlevsno+1:0))
    !--------------------------
    ...
    !added by Jing Chen, 17 May 2012
    ! variables for EASS code
    cwf%densnow_EASS(beg:end)    = nan
    cwf%densnow_EASS(beg:end) = nan
    cwf%qflx_drain_EASS(beg:end) = nan
    cwf%qflx_glcice_EASS(beg:end) = nan
    cwf%qflx_infl_EASS(beg:end) = nan
    cwf%qflx_qrgwl_EASS(beg:end) = nan
    cwf%qflx_rsub_sat_EASS(beg:end) = nan
    cwf%qflx_runoff_EASS(beg:end) = nan
    cwf%qflx_runoff_r_EASS(beg:end) = nan
    cwf%qflx_runoff_u_EASS(beg:end) = nan
    cwf%qflx_snomelt_EASS(beg:end) = nan
    cwf%qflx_surf_EASS(beg:end) = nan
    cwf%qflx_top_soil_EASS(beg:end) = nan
    cwf%qflx_snofrz_lyr_EASS(beg:end,-nlevsno+1:0) = spval
    !--------------------------
