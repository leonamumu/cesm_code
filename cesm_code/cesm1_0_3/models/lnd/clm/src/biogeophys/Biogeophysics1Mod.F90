...
!
    ...
    real(r8), pointer :: qflx_evap_soi_EASS(:)        ! water(liquid) evaporation from soi[mmH2O s-1]
    real(r8), pointer :: qflx_evap_grnd_EASS(:)        ! water(liquid) evaporation from soi[mmH2O s-1]
    ...
    real(r8), pointer :: eflx_lh_tot_u_EASS(:)        ! urban total latent heat flux [W m-2]
    real(r8), pointer :: eflx_sh_tot_u_EASS(:)        ! urban total sensible heat flux [W m-2]
    real(r8), pointer :: eflx_lh_tot_r_EASS(:)        ! rural total latent heat flux [W m-2]
    real(r8), pointer :: eflx_sh_tot_r_EASS(:)        ! rural total sensible heat flux [W m-2]
...
!------------------------------------------------------------------------------
   ...
   ! Assign local pointers to derived type members (gridcell-level)
    ...
    t_grnd_bef_EASS => clm3%g%l%c%ces%t_grnd_bef_EASS
   ...
   !-------------------------------------------
    ...
    do j = -nlevsno+1, nlevgrnd
       do fc = 1,num_nolakec
          ...
          tssbef_EASS(c,j) = t_soisno_EASS(c,j)
       end do
    end do
    ...
    do fc = 1,num_nolakec
       ...
       t_grnd_bef(c)=t_grnd(c)
       t_grnd_bef_EASS(c)=t_grnd_EASS(c)
    ...
    do fp = 1,num_nolakep
       ...
       if (ityplun(l) == isturb) then
         ...
         eflx_sh_tot_u_EASS(p) = 0._r8    !added by Jing Chen, Sep 9 2102
       else if (ityplun(l) == istsoil .or. ityplun(l) == istcrop) then 
         eflx_sh_tot_r(p)      = 0._r8
         eflx_sh_tot_r_EASS(p) = 0._r8    !added by Jing Chen, Sep 9 2102
       end if
       eflx_lh_tot(p) = 0._r8
       if (ityplun(l) == isturb) then
         eflx_lh_tot_u(p)      = 0._r8
         eflx_lh_tot_u_EASS(p) = 0._r8     !added by Jing Chen, Sep 9 2102
       else if (ityplun(l) == istsoil .or. ityplun(l) == istcrop) then 
         eflx_lh_tot_r(p)      = 0._r8
         eflx_lh_tot_r_EASS(p) = 0._r8     !added by Jing Chen, Sep 9 2102
       end if
       eflx_sh_veg(p)   = 0._r8
       ...
       !-------------------
       ! added by Jing Chen, 26 May,2012
       eflx_sh_over_EASS(p)  = 0._r8
       eflx_sh_under_EASS(p) = 0._r8
       clm3%g%l%c%p%pef%eflx_sh_under_sunlit_EASS(p) = 0._r8
       clm3%g%l%c%p%pef%eflx_sh_over_shaded_EASS(p)  = 0._r8
       clm3%g%l%c%p%pef%eflx_sh_under_shaded_EASS(p) = 0._r8
       clm3%g%l%c%p%pef%eflx_sh_over_sunlit_EASS(p)  = 0._r8
       eflx_sh_grnd_EASS(p)  = 0._r8
       eflx_sh_tot_EASS(p)   = 0._r8
       eflx_lh_tot_EASS(p)   = 0._r8
       clm3%g%l%c%p%pef%eflx_lh_over_EASS(p)   = 0._r8
       clm3%g%l%c%p%pef%eflx_lh_under_EASS(p)  = 0._r8


       qflx_trans_over_EASS(p)  = 0._r8
       qflx_trans_under_EASS(p) = 0._r8
       clm3%g%l%c%p%pwf%qflx_trans_over_sunlit_EASS(p)  = 0._r8
       clm3%g%l%c%p%pwf%qflx_trans_under_sunlit_EASS(p) = 0._r8
       clm3%g%l%c%p%pwf%qflx_trans_over_shaded_EASS(p)  = 0._r8
       clm3%g%l%c%p%pwf%qflx_trans_under_shaded_EASS(p) = 0._r8
       qflx_evap_over_EASS(p)  = 0._r8
       qflx_evap_under_EASS(p) = 0._r8
       clm3%g%l%c%p%pwf%qflx_evap_over_sunlit_EASS(p)  = 0._r8
       clm3%g%l%c%p%pwf%qflx_evap_under_sunlit_EASS(p) = 0._r8
       clm3%g%l%c%p%pwf%qflx_evap_over_shaded_EASS(p)  = 0._r8
       clm3%g%l%c%p%pwf%qflx_evap_under_shaded_EASS(p) = 0._r8
       qflx_evap_soi_EASS(p)  = 0._r8
       qflx_evap_grnd_EASS(p) = 0._r8
       qflx_evap_pond_EASS(p) = 0._r8
       qflx_evap_snow_over_EASS(p)  = 0._r8
       qflx_evap_snow_under_EASS(p) = 0._r8
       clm3%g%l%c%p%pwf%qflx_evap_snow_over_sunlit_EASS(p)  = 0._r8
       clm3%g%l%c%p%pwf%qflx_evap_snow_under_sunlit_EASS(p) = 0._r8
       clm3%g%l%c%p%pwf%qflx_evap_snow_over_shaded_EASS(p)  = 0._r8
       clm3%g%l%c%p%pwf%qflx_evap_snow_under_shaded_EASS(p) = 0._r8
       qflx_evap_snow_grnd_EASS(p) = 0._r8
       qflx_evap_tot_EASS(p) = 0._r8

       ! stomatal resistant of leaves
       clm3%g%l%c%p%pps%rs_over_sunlit_EASS(p)=200.0_r8
       clm3%g%l%c%p%pps%rs_over_shaded_EASS(p)=200.0_r8
       clm3%g%l%c%p%pps%rs_under_sunlit_EASS(p)=300.0_r8
       clm3%g%l%c%p%pps%rs_under_shaded_EASS(p)=300.0_r8
